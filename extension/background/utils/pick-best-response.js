...
exports.pickBestReponse = pickBestReponse;
exports.pickResponsesWithSimilarityGreaterThan = pickResponsesWithSimilarityGreaterThan;
exports.toPourcentage = toPourcentage;
/**
 ...
 * @returns
 */
function sentenceSimilarity(str1, str2) {
 ...
 * @returns
 */
function pickBestReponse(answer, arr) {
  let bestResponse = {
    element: null,
    similarity: 0,
    value: null
 ...
 * @returns
 */
function pickResponsesWithSimilarityGreaterThan(answer, arr, score) {
  const responses = [];
  for (const obj of arr) {
    const similarity = sentenceSimilarity(obj.value, answer);
    if (similarity >= score)
 ...
 * @param similarity
 */
function toPourcentage(similarity) {
  return Math.round(similarity * 100 * 100) / 100 + '%';
}
//# sourceMappingURL=pick-best-response.js.map
